#############################################################################
# Makefile for building: textviewer
# Generated by qmake (3.1) (Qt 5.15.14)
# Project:  textviewer.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile textviewer.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = textviewer1.0.0
DISTDIR = /home/honeyguide/Desktop/MyOpenSource/mdflash/.tmp/textviewer1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /../lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		textviewer.pro  textviewer.cpp
QMAKE_TARGET  = textviewer
DESTDIR       = 
TARGET        = textviewer
...
Makefile: textviewer.pro /../lib64/qt5/mkspecs/linux-g++/qmake.conf /../lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
		...
		/../lib64/qt5/mkspecs/features/lex.prf \
		textviewer.pro
	$(QMAKE) -o Makefile textviewer.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents textviewer.cpp $(DISTDIR)/
